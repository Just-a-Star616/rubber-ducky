...
export const mockTransactionsByDriver: { [driverId: string]: Transaction[] } = {
  'D-DEMO': [
    // Last 7 days transactions (this week) - realistic daily earnings
    { id: 'TR-DEMO-001', datetime: new Date(Date.now() - 1 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 145.50 },
    { id: 'TR-DEMO-002', datetime: new Date(Date.now() - 1 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 128.00 },
    { id: 'TR-DEMO-003', datetime: new Date(Date.now() - 2 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 120.00 },
    { id: 'TR-DEMO-004', datetime: new Date(Date.now() - 2 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 115.50 },
    { id: 'TR-DEMO-005', datetime: new Date(Date.now() - 2 * 24 * 3600 * 1000).toISOString(), type: 'Account', amount: 145.00 },
    { id: 'TR-DEMO-006', datetime: new Date(Date.now() - 3 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 115.75 },
    { id: 'TR-DEMO-007', datetime: new Date(Date.now() - 3 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 122.25 },
    { id: 'TR-DEMO-008', datetime: new Date(Date.now() - 4 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 165.00 },
    { id: 'TR-DEMO-009', datetime: new Date(Date.now() - 4 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 138.50 },
    { id: 'TR-DEMO-010', datetime: new Date(Date.now() - 5 * 24 * 3600 * 1000).toISOString(), type: 'Account', amount: 180.20 },
    { id: 'TR-DEMO-011', datetime: new Date(Date.now() - 5 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 142.00 },
    { id: 'TR-DEMO-012', datetime: new Date(Date.now() - 6 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 112.00 },
    { id: 'TR-DEMO-013', datetime: new Date(Date.now() - 6 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 148.75 },
    { id: 'TR-DEMO-014', datetime: new Date(Date.now() - 7 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 135.00 },
    { id: 'TR-DEMO-015', datetime: new Date(Date.now() - 7 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 155.25 },
    
    // Previous week transactions
    { id: 'TR-DEMO-016', datetime: new Date(Date.now() - 8 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 142.00 },
    { id: 'TR-DEMO-017', datetime: new Date(Date.now() - 9 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 128.50 },
    { id: 'TR-DEMO-018', datetime: new Date(Date.now() - 10 * 24 * 3600 * 1000).toISOString(), type: 'Account', amount: 165.75 },
    { id: 'TR-DEMO-019', datetime: new Date(Date.now() - 11 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 138.00 },
    { id: 'TR-DEMO-020', datetime: new Date(Date.now() - 12 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 152.50 },
    { id: 'TR-DEMO-021', datetime: new Date(Date.now() - 13 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 125.00 },
    { id: 'TR-DEMO-022', datetime: new Date(Date.now() - 14 * 24 * 3600 * 1000).toISOString(), type: 'Account', amount: 148.00 },
    
    // Two weeks ago transactions
    { id: 'TR-DEMO-023', datetime: new Date(Date.now() - 15 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 145.50 },
    { id: 'TR-DEMO-024', datetime: new Date(Date.now() - 16 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 132.00 },
    { id: 'TR-DEMO-025', datetime: new Date(Date.now() - 17 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 168.75 },
    { id: 'TR-DEMO-026', datetime: new Date(Date.now() - 18 * 24 * 3600 * 1000).toISOString(), type: 'Account', amount: 155.00 },
    { id: 'TR-DEMO-027', datetime: new Date(Date.now() - 19 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 141.25 },
    { id: 'TR-DEMO-028', datetime: new Date(Date.now() - 20 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 128.50 },
    { id: 'TR-DEMO-029', datetime: new Date(Date.now() - 21 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 158.00 },
  ],
  'D001': [
    { id: 'TR001-D001', datetime: new Date(Date.now() - 1 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 132.00 },
    { id: 'TR002-D001', datetime: new Date(Date.now() - 2 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 118.50 },
    { id: 'TR003-D001', datetime: new Date(Date.now() - 3 * 24 * 3600 * 1000).toISOString(), type: 'Account', amount: 142.00 },
  ],
  'D002': [
    { id: 'TR001-D002', datetime: new Date(Date.now() - 1 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 125.00 },
    { id: 'TR002-D002', datetime: new Date(Date.now() - 2 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 135.50 },
  ],
  'D004': [
    { id: 'TR001-D004', datetime: new Date(Date.now() - 1 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 148.00 },
    { id: 'TR002-D004', datetime: new Date(Date.now() - 2 * 24 * 3600 * 1000).toISOString(), type: 'Account', amount: 152.50 },
  ],
  'D005': [
    { id: 'TR001-D005', datetime: new Date(Date.now() - 1 * 24 * 3600 * 1000).toISOString(), type: 'Card', amount: 155.00 },
    { id: 'TR002-D005', datetime: new Date(Date.now() - 2 * 24 * 3600 * 1000).toISOString(), type: 'Cash', amount: 130.00 },
  ],
};
