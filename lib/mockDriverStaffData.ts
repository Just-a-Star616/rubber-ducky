...
export const mockPermissionStructure: PermissionNode[] = [
    ...
    { id: 'audit', name: 'Audit & Logs', children: [
        { id: 'audit-logs', name: 'View Activity Logs', children: [
            { id: 'audit-logs-view', name: 'View All Logs' },
            { id: 'audit-logs-filter', name: 'Filter & Search Logs' },
            { id: 'audit-logs-export', name: 'Export Logs (JSON/CSV)' },
            { id: 'audit-logs-own', name: 'View Own Activity Only' }
        ]},
        { id: 'audit-scoped', name: 'Scoped Access', children: [
            { id: 'audit-scoped-staff', name: 'View Staff Changes' },
            { id: 'audit-scoped-financial', name: 'View Financial Logs' },
            { id: 'audit-scoped-dispatch', name: 'View Dispatch Activity' },
            { id: 'audit-scoped-drivers', name: 'View Driver Changes' }
        ]}
    ]},
