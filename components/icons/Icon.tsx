...
export const ShieldExclamationIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const CollectionIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0l5-4 5 4M5 11V9a2 2 0 012-2" />
  </svg>
);
...
export const ArchiveIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const CurrencyPoundIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const GiftIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V6a2 2 0 00-2 2h2zm0 13l-4-4h8l-4 4zm0 0v-5" />
...
export const CommandLineIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 7.5l3 2.25-3 2.25m4.5-3h6m-6 4.5h6m-6 4.5h6m-9.75-4.5a1.125 1.125 0 01-1.125-1.125V12a1.125 1.125 0 011.125-1.125m11.25 0a1.125 1.125 0 011.125 1.125V15a1.125 1.125 0 01-1.125 1.125M3.375 4.5c-.621 0-1.125.504-1.125 1.125v12.75c0 .621.504 1.125 1.125 1.125h17.25c.621 0 1.125-.504 1.125-1.125V5.625c0-.621-.504-1.125-1.125-1.125H3.375z" />
    </svg>
);
...
export const FireIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.362-3.797A8.333 8.333 0 0112 2.25c1.153 0 2.243.3 3.224.862l.362.152z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75A6.75 6.75 0 0018.75 12c0-1.734-.672-3.352-1.774-4.526l-.526-.654A6.752 6.752 0 0012 4.5a6.75 6.75 0 00-6.75 6.75c0 3.726 3.024 6.75 6.75 6.75z" />
    </svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.964 2.508-2.316 2.752a27.135 27.135 0 01-11.868 0C4.714 20.733 3.75 19.537 3.75 18.225V14.15M16.5 18.75h-9" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 13.5V6.75a2.25 2.25 0 00-2.25-2.25h-13.5A2.25 2.25 0 003 6.75v6.75m18 0a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25h-13.5A2.25 2.25 0 003 6.75v6.75m18 0v-6.75a2.25 2.25 0 00-2.25-2.25H3.75a2.25 2.25 0 00-2.25 2.25v6.75" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75a.75.75 0 00-1.5 0v2.25a.75.75 0 001.5 0v-2.25z" />
    </svg>
);
...
export const IdentificationIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5h.01M8.25 10.5h.01M8.25 13.5h.01" />
    </svg>
);
...
export const PawPrintIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
...
export const AccessibleIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="16" cy="4" r="1"/><path d="m18 19 1-7-6 1"/>
        <path d="m5 8 3-3 5.5 3-2.36 3.5"/><path d="M4.24 14.5a5 5 0 0 0 6.88 6"/>
